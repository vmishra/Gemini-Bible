...
def main(
    ...
    return {
        ...
        # breakdowns, thinking tokens, and cache details from this. The runner
        # is permissive about extra keys but requires (model, usage_metadata,
        # finish_reason) to remain.
